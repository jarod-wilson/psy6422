...
# This line sets how long the anination should last, how fast it animates, and how long it pauses for at the end.
animate(g_anim, duration = 20, fps = 10, end_pause = 50)
...
The repo for this project can be found [here](https://github.com/jarod-wilson/psy6422).
